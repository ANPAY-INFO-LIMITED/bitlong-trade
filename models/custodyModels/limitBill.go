...
type LimitBill struct {
	...
	TotalAmount   float64   `gorm:"column:total_amount;type:decimal(25,2)" json:"totalAmount"`
	UseAbleAmount float64   `gorm:"column:use_able_amount;type:decimal(25,2)" json:"useAbleAmount"`
